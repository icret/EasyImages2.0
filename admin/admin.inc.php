    ...
    <div class="tab-content col-md-10 col-xs-8">
        ...
        <div class=" tab-pane fade" id="Content8">
            <div class="alert alert-primary">
                ...
                <a href="https://icret.gitee.io/easyimages2.0/#/./使用ShareX上传" target="_blank"><span class="label label-badge label-primary" data-toggle="tooltip" title="使用ShareX上传">ShareX</span></a>
                <a href="https://icret.gitee.io/easyimages2.0/#/./使用PicGo上传" target="_blank"><span class="label label-badge label-primary" data-toggle="tooltip" title="使用PicGo上传">PicGo</span></a>
                <h6>开发支持</h6>
                <p>
                    ...
                    <a href="<?php echo is_file(APP_ROOT . '/docs/index.html') ? $config['domain'] . '/docs' : 'https://icret.gitee.io/easyimages2.0/#/'; ?>" target="_blank"><span class="label label-badge label-primary" data-toggle="tooltip" title="使用手册"><i class="icon icon-book"></i> Manual</span></a>
