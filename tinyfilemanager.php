...
require_once __DIR__.'/libs/function.php'; tinyfilemanager();
/**
...
if (isset($_GET['upload']) && !FM_READONLY) {
    ...
    <link href="<?php static_cdn();?>/public/static/dropzone.min.css" rel="stylesheet">
    <div class="path">
    ...
    <script src="<?php static_cdn();?>/public/static/dropzone.min.js"></script>
    <script>
        ...
        <table class="table table-bordered table-hover table-sm <?php echo $tableTheme; ?>" id="main-table">
            ...
            foreach ($files as $f) {
                ...
                <tr>
                    ...
                    <td>
                        <div class="filename">
                             <a href="<?php echo fm_enc(FM_ROOT_URL . (FM_PATH != '' ? '/' . FM_PATH : '') . '/' . $f) ?>" data-toggle="lightbox" data-group="image-group-1"><img src="<?php echo fm_enc(FM_ROOT_URL . (FM_PATH != '' ? '/' . FM_PATH : '') . '/' . $f) ?>" width="100px" height="100px" class="img-rounded"></a></div>
                    </td>
...
<head>
    ...
    <link rel="stylesheet" href="<?php static_cdn();?>/public/static/bootstrap.min.css">
    <style>
...
<script src="<?php static_cdn();?>/public/static/jquery.slim.min.js"></script>
<script src="<?php static_cdn();?>/public/static/bootstrap.min.js"></script>
</body>
</html>
<?php
}
...
<head>
    ...
    <?php if($favicon_path) { echo '<link rel="icon" href="'.fm_enc($favicon_path).'" type="image/png">'; } ?>
    <title><?php echo fm_enc(APP_TITLE) ?></title>
    <link href="<?php static_cdn();?>/public/static/bootstrap.min.css" rel="stylesheet">
    <link href="<?php static_cdn();?>/public/static/font-awesome.min.css" rel="stylesheet">
    <link href="<?php static_cdn();?>/public/static/ekko-lightbox.css" rel="stylesheet">
    <?php if (FM_USE_HIGHLIGHTJS): ?>
    <link rel="stylesheet" href="<?php static_cdn();?>/public/static/vs.min.css">
	<?php endif; ?>
    <style>
...
<script src="<?php static_cdn();?>/public/static/bootstrap.min.js"></script>
<script src="<?php static_cdn();?>/public/static/jquery.dataTables.min.js"></script>
<script src="<?php static_cdn();?>/public/static/ekko-lightbox.min.js"></script>
<?php if (FM_USE_HIGHLIGHTJS): ?>
    <script src="<?php static_cdn();?>/public/static/highlight.min.js"></script>
...
<script>
    ...
    //TFM Config
    window.curi = "<?php static_cdn();?>/public/static/config.json", window.config = null;
...
/**
 * EasyImage - 简单图床tinyfilemanager.php配置
 * @modify by icret
 * @email  lemonim@qq.com
 * @Github  https://github.com/icret/easyImages2.0
 * @Review 2021-04-19 23:23:40
 * ----------------修改日志---------------------*
 * 所有静态文件本地化
	行 1162:    <link href="public/static/dropzone.min.css" rel="stylesheet">
	行 2374:    $content = @file_get_contents('public/static/translation.json');
	行 3391:    <link rel="stylesheet" href="public/static/bootstrap.min.css">
	行 3431:    <script src="public/static/jquery.slim.min.js"></script>
	行 3432:    <script src="public/static/bootstrap.min.js"></script>
	行 3463:    <link href="public/static/bootstrap.min.css" rel="stylesheet">
	行 3464:    <link href="public/static/font-awesome.min.css" rel="stylesheet">
	行 3465:    <link href="public/static/ekko-lightbox.css" rel="stylesheet">
	行 3467:    <link rel="stylesheet" href="public/static/vs.min.css">
	行 3696:    <script src="public/static/zui/lib/jquery/jquery-3.4.1.min.js?v3.4.1"></script>
	行 3697:    <script src="public/static/bootstrap.min.js"></script>
	行 3698:    <script src="public/static/jquery.dataTables.min.js"></script>
	行 3699:    <script src="public/static/ekko-lightbox.min.js"></script>
 ...
 * 更改默认配置
    行    3:    $CONFIG = '{"lang":"zh-CN","error_reporting":false,"show_hidden":false,"hide_Cols":false,"calc_folder":false}';
 * 添加函数
